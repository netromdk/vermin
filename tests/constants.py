...
class VerminConstantMemberTests(VerminTest):
  ...
  def test_name_of_ImportError(self):
    self.assertOnlyIn((3, 3), detect("ImportError.name"))

  def test_path_of_ImportError(self):
    self.assertOnlyIn((3, 3), detect("ImportError.path"))

  def test_filename2_of_OSError(self):
    self.assertOnlyIn((3, 4), detect("OSError.filename2"))

  def test_value_of_StopIteration(self):
    self.assertOnlyIn((3, 3), detect("StopIteration.value"))

  def test_encoding_of_file(self):
    self.assertOnlyIn((2, 3), detect("file.encoding"))

  def test_errors_of_file(self):
    self.assertOnlyIn((2, 6), detect("file.errors"))

  def test_start_of_range(self):
    self.assertOnlyIn((3, 3), detect("range.start"))

  def test_step_of_range(self):
    self.assertOnlyIn((3, 3), detect("range.step"))

  def test_stop_of_range(self):
    self.assertOnlyIn((3, 3), detect("range.stop"))
  ...
  def test_float_repr_style_of_sys(self):
    self.assertOnlyIn(((2, 7), (3, 1)), detect("from sys import float_repr_style"))
  ...
  def test_subversion_of_sys(self):
    self.assertOnlyIn(((2, 5), (3, 0)), detect("from sys import subversion"))
  ...
  def test_session_of_ssl_SSLSocket(self):
    self.assertOnlyIn((3, 6), detect("from ssl import SSLSocket\nSSLSocket.session"))
  ...
  def test_OP_ENABLE_MIDDLEBOX_COMPAT_of_ssl(self):
    self.assertOnlyIn(((2, 7), (3, 8)), detect("from ssl import OP_ENABLE_MIDDLEBOX_COMPAT"))
  ...
  def test_httponly_from_Cookie_Morsel(self):
    self.assertOnlyIn((2, 6),
                      detect("from Cookie import Morsel\n"
                             "Morsel().httponly"))

  def test_TIMEOUT_MAX_of__thread(self):
    self.assertOnlyIn((3, 2), detect("from _thread import TIMEOUT_MAX"))
  ...
  def test__field_defaults_from_collections_namedtuple(self):
    self.assertOnlyIn((3, 7),
                      detect("from collections import namedtuple\n"
  ...
  def test_encoding_from_curses_window(self):
    self.assertOnlyIn((3, 3),
                      detect("from curses import window\n"
                             "window().encoding"))
  ...
  def test_COMPARISON_FLAGS_of_doctest(self):
    self.assertOnlyIn(((2, 4), (3, 0)), detect("from doctest import COMPARISON_FLAGS"))

  def test_DONT_ACCEPT_BLANKLINE_of_doctest(self):
    self.assertOnlyIn(((2, 4), (3, 0)), detect("from doctest import DONT_ACCEPT_BLANKLINE"))

  def test_ELLIPSIS_of_doctest(self):
    self.assertOnlyIn(((2, 4), (3, 0)), detect("from doctest import ELLIPSIS"))

  def test_IGNORE_EXCEPTION_DETAIL_of_doctest(self):
    self.assertOnlyIn(((2, 4), (3, 0)), detect("from doctest import IGNORE_EXCEPTION_DETAIL"))

  def test_NORMALIZE_WHITESPACE_of_doctest(self):
    self.assertOnlyIn(((2, 4), (3, 0)), detect("from doctest import NORMALIZE_WHITESPACE"))

  def test_REPORTING_FLAGS_of_doctest(self):
    self.assertOnlyIn(((2, 4), (3, 0)), detect("from doctest import REPORTING_FLAGS"))

  def test_REPORT_CDIFF_of_doctest(self):
    self.assertOnlyIn(((2, 4), (3, 0)), detect("from doctest import REPORT_CDIFF"))

  def test_REPORT_NDIFF_of_doctest(self):
    self.assertOnlyIn(((2, 4), (3, 0)), detect("from doctest import REPORT_NDIFF"))

  def test_REPORT_ONLY_FIRST_FAILURE_of_doctest(self):
    self.assertOnlyIn(((2, 4), (3, 0)), detect("from doctest import REPORT_ONLY_FIRST_FAILURE"))

  def test_REPORT_UDIFF_of_doctest(self):
    self.assertOnlyIn(((2, 4), (3, 0)), detect("from doctest import REPORT_UDIFF"))

  def test_SKIP_of_doctest(self):
    self.assertOnlyIn(((2, 5), (3, 0)), detect("from doctest import SKIP"))
  ...
  def test_content_manager_from_email_policy_EmailPolicy(self):
    self.assertOnlyIn((3, 4),
                      detect("from email.policy import EmailPolicy\n"
  ...
  def test_F_ADD_SEALS_of_fcntl(self):
    self.assertOnlyIn((3, 8), detect("from fcntl import F_ADD_SEALS"))

  def test_F_GET_SEALS_of_fcntl(self):
    self.assertOnlyIn((3, 8), detect("from fcntl import F_GET_SEALS"))

  def test_F_SEAL_GROW_of_fcntl(self):
    self.assertOnlyIn((3, 8), detect("from fcntl import F_SEAL_GROW"))

  def test_F_SEAL_SEAL_of_fcntl(self):
    self.assertOnlyIn((3, 8), detect("from fcntl import F_SEAL_SEAL"))

  def test_F_SEAL_SHRINK_of_fcntl(self):
    self.assertOnlyIn((3, 8), detect("from fcntl import F_SEAL_SHRINK"))
  ...
  def test_callbacks_of_gc(self):
    self.assertOnlyIn((3, 3), detect("from gc import callbacks"))
  ...
  def test_name_from_hashlib_hash(self):
    self.assertOnlyIn((3, 4),
                      detect("from hashlib import hash\n"
                             "hash().name"))

  def test_codepoint2name_of_htmlentitydefs(self):
    self.assertOnlyIn((2, 3), detect("from htmlentitydefs import codepoint2name"))

  def test_name2codepoint_of_htmlentitydefs(self):
    self.assertOnlyIn((2, 3), detect("from htmlentitydefs import name2codepoint"))
  ...
  def test_responses_of_httplib(self):
    self.assertOnlyIn((2, 5), detect("from httplib import responses"))
  ...
  def test_description_from_inspect_Parameter_kind(self):
    self.assertOnlyIn((3, 8),
                      detect("from inspect.Parameter import kind\n"
                             "kind().description"))

  def test_SEEK_CUR_of_io(self):
    self.assertOnlyIn(((2, 7), (3, 1)), detect("from io import SEEK_CUR"))

  def test_SEEK_END_of_io(self):
    self.assertOnlyIn(((2, 7), (3, 1)), detect("from io import SEEK_END"))

  def test_SEEK_SET_of_io(self):
    self.assertOnlyIn(((2, 7), (3, 1)), detect("from io import SEEK_SET"))

  def test_write_through_from_io_TextIOWrapper(self):
    self.assertOnlyIn((3, 7),
                      detect("from io import TextIOWrapper\n"
  ...
  def test_terminator_from_logging_StreamHandler(self):
    self.assertOnlyIn((3, 2),
                      detect("from logging import StreamHandler\n"
                             "StreamHandler().terminator"))

  def test_name_from_logging_handlers_BaseRotatingHandler(self):
    self.assertOnlyIn((3, 3),
                      detect("from logging.handlers import BaseRotatingHandler\n"
  ...
  def test_version_of_marshal(self):
    self.assertOnlyIn(((2, 4), (3, 0)), detect("from marshal import version"))

  def test_closed_from_mmap_mmap(self):
    self.assertOnlyIn((3, 2),
                      detect("from mmap import mmap\n"
                             "mmap().closed"))
  ...
  def test_CLD_CONTINUED_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import CLD_CONTINUED"))

  def test_CLD_DUMPED_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import CLD_DUMPED"))

  def test_CLD_EXITED_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import CLD_EXITED"))
  ...
  def test_EX_CONFIG_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_CONFIG"))

  def test_EX_DATAERR_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_DATAERR"))

  def test_EX_IOERR_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_IOERR"))

  def test_EX_NOHOST_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_NOHOST"))

  def test_EX_NOINPUT_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_NOINPUT"))

  def test_EX_NOPERM_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_NOPERM"))

  def test_EX_NOTFOUND_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_NOTFOUND"))

  def test_EX_NOUSER_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_NOUSER"))

  def test_EX_OK_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_OK"))

  def test_EX_OSERR_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_OSERR"))

  def test_EX_OSFILE_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_OSFILE"))

  def test_EX_PROTOCOL_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_PROTOCOL"))

  def test_EX_SOFTWARE_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_SOFTWARE"))

  def test_EX_TEMPFAIL_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_TEMPFAIL"))

  def test_EX_UNAVAILABLE_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_UNAVAILABLE"))

  def test_EX_USAGE_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import EX_USAGE"))

  def test_GRND_NONBLOCK_of_os(self):
    self.assertOnlyIn((3, 6), detect("from os import GRND_NONBLOCK"))

  def test_GRND_RANDOM_of_os(self):
    self.assertOnlyIn((3, 6), detect("from os import GRND_RANDOM"))

  def test_P_ALL_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import P_ALL"))

  def test_P_PGID_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import P_PGID"))

  def test_P_PID_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import P_PID"))

  def test_RTLD_DEEPBIND_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import RTLD_DEEPBIND"))

  def test_RTLD_GLOBAL_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import RTLD_GLOBAL"))

  def test_RTLD_LAZY_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import RTLD_LAZY"))

  def test_RTLD_LOCAL_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import RTLD_LOCAL"))

  def test_RTLD_NODELETE_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import RTLD_NODELETE"))

  def test_RTLD_NOLOAD_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import RTLD_NOLOAD"))

  def test_RTLD_NOW_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import RTLD_NOW"))

  def test_RWF_DSYNC_of_os(self):
    self.assertOnlyIn((3, 7), detect("from os import RWF_DSYNC"))

  def test_RWF_HIPRI_of_os(self):
    self.assertOnlyIn((3, 7), detect("from os import RWF_HIPRI"))

  def test_RWF_NOWAIT_of_os(self):
    self.assertOnlyIn((3, 7), detect("from os import RWF_NOWAIT"))

  def test_RWF_SYNC_of_os(self):
    self.assertOnlyIn((3, 7), detect("from os import RWF_SYNC"))

  def test_SCHED_BATCH_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import SCHED_BATCH"))

  def test_SCHED_FIFO_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import SCHED_FIFO"))

  def test_SCHED_IDLE_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import SCHED_IDLE"))

  def test_SCHED_OTHER_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import SCHED_OTHER"))

  def test_SCHED_RESET_ON_FORK_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import SCHED_RESET_ON_FORK"))

  def test_SCHED_RR_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import SCHED_RR"))

  def test_SCHED_SPORADIC_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import SCHED_SPORADIC"))

  def test_SEEK_CUR_of_os(self):
    self.assertOnlyIn(((2, 5), (3, 0)), detect("from os import SEEK_CUR"))

  def test_SEEK_DATA_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import SEEK_DATA"))

  def test_SEEK_END_of_os(self):
    self.assertOnlyIn(((2, 5), (3, 0)), detect("from os import SEEK_END"))

  def test_SEEK_HOLE_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import SEEK_HOLE"))

  def test_SEEK_SET_of_os(self):
    self.assertOnlyIn(((2, 5), (3, 0)), detect("from os import SEEK_SET"))

  def test_ST_APPEND_of_os(self):
    self.assertOnlyIn((3, 4), detect("from os import ST_APPEND"))

  def test_ST_IMMUTABLE_of_os(self):
    self.assertOnlyIn((3, 4), detect("from os import ST_IMMUTABLE"))

  def test_ST_MANDLOCK_of_os(self):
    self.assertOnlyIn((3, 4), detect("from os import ST_MANDLOCK"))

  def test_ST_NOATIME_of_os(self):
    self.assertOnlyIn((3, 4), detect("from os import ST_NOATIME"))

  def test_ST_NODEV_of_os(self):
    self.assertOnlyIn((3, 4), detect("from os import ST_NODEV"))

  def test_ST_NODIRATIME_of_os(self):
    self.assertOnlyIn((3, 4), detect("from os import ST_NODIRATIME"))

  def test_ST_NOEXEC_of_os(self):
    self.assertOnlyIn((3, 4), detect("from os import ST_NOEXEC"))

  def test_ST_NOSUID_of_os(self):
    self.assertOnlyIn((3, 2), detect("from os import ST_NOSUID"))

  def test_ST_RDONLY_of_os(self):
    self.assertOnlyIn((3, 2), detect("from os import ST_RDONLY"))

  def test_ST_RELATIME_of_os(self):
    self.assertOnlyIn((3, 4), detect("from os import ST_RELATIME"))

  def test_ST_SYNCHRONOUS_of_os(self):
    self.assertOnlyIn((3, 4), detect("from os import ST_SYNCHRONOUS"))

  def test_ST_WRITE_of_os(self):
    self.assertOnlyIn((3, 4), detect("from os import ST_WRITE"))

  def test_WCONTINUED_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import WCONTINUED"))

  def test_WEXITED_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import WEXITED"))

  def test_WNOWAIT_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import WNOWAIT"))

  def test_WSTOPPED_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import WSTOPPED"))

  def test_WUNTRACED_of_os(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from os import WUNTRACED"))

  def test_devnull_of_os(self):
    self.assertOnlyIn(((2, 4), (3, 0)), detect("from os import devnull"))

  def test_extsep_of_os(self):
    self.assertOnlyIn(((2, 2), (3, 0)), detect("from os import extsep"))
  ...
  def test_supports_dir_fd_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import supports_dir_fd"))

  def test_supports_effective_ids_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import supports_effective_ids"))

  def test_supports_fd_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import supports_fd"))

  def test_supports_follow_symlinks_of_os(self):
    self.assertOnlyIn((3, 3), detect("from os import supports_follow_symlinks"))

  def test_HIGHEST_PROTOCOL_of_pickle(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from pickle import HIGHEST_PROTOCOL"))
  ...
  def test_SortKey_of_pstats(self):
    self.assertOnlyIn((3, 7), detect("from pstats import SortKey"))

  def test_children_from_pyclbr_Class(self):
    self.assertOnlyIn((3, 7),
                      detect("from pyclbr import Class\n"
                             "Class().children"))
  ...
  def test_children_from_pyclbr_Function(self):
    self.assertOnlyIn((3, 7),
                      detect("from pyclbr import Function\n"
                             "Function().children"))
  ...
  def test_RLIMIT_NICE_of_resource(self):
    self.assertOnlyIn((3, 4), detect("from resource import RLIMIT_NICE"))

  def test_RLIMIT_NPTS_of_resource(self):
    self.assertOnlyIn((3, 4), detect("from resource import RLIMIT_NPTS"))

  def test_RLIMIT_RTPRIO_of_resource(self):
    self.assertOnlyIn((3, 4), detect("from resource import RLIMIT_RTPRIO"))

  def test_RLIMIT_RTTIME_of_resource(self):
    self.assertOnlyIn((3, 4), detect("from resource import RLIMIT_RTTIME"))

  def test_RLIMIT_SBSIZE_of_resource(self):
    self.assertOnlyIn((3, 4), detect("from resource import RLIMIT_SBSIZE"))

  def test_RLIMIT_SIGPENDING_of_resource(self):
    self.assertOnlyIn((3, 4), detect("from resource import RLIMIT_SIGPENDING"))

  def test_RLIMIT_SWAP_of_resource(self):
    self.assertOnlyIn((3, 4), detect("from resource import RLIMIT_SWAP"))

  def test_RUSAGE_THREAD_of_resource(self):
    self.assertOnlyIn((3, 2), detect("from resource import RUSAGE_THREAD"))

  def test_ru_idrss_from_resource_getrusage(self):
    self.assertOnlyIn(((2, 3), (3, 0)),
                      detect("from resource import getrusage\n"
                             "getrusage().ru_idrss"))
  ...
  def test_EPOLLEXCLUSIVE_of_select(self):
    self.assertOnlyIn((3, 6), detect("from select import EPOLLEXCLUSIVE"))

  def test_PIPE_BUF_of_select(self):
    self.assertOnlyIn(((2, 7), (3, 2)), detect("from select import PIPE_BUF"))

  def test_closed_from_select_devpoll(self):
    self.assertOnlyIn((3, 4),
                      detect("from select import devpoll\n"
                             "devpoll().closed"))

  def test_eof_from_shlex_shlex(self):
    self.assertOnlyIn(((2, 3), (3, 0)),
                      detect("from shlex import shlex\n"
                             "shlex().eof"))
  ...
  def test_avoids_symlink_attacks_from_shutil_rmtree(self):
    self.assertOnlyIn((3, 3),
                      detect("from shutil import rmtree\n"
                             "rmtree().avoids_symlink_attacks"))

  def test_CTRL_BREAK_EVENT_of_signal(self):
    self.assertOnlyIn(((2, 7), (3, 2)), detect("from signal import CTRL_BREAK_EVENT"))

  def test_CTRL_C_EVENT_of_signal(self):
    self.assertOnlyIn(((2, 7), (3, 2)), detect("from signal import CTRL_C_EVENT"))

  def test_SIG_BLOCK_of_signal(self):
    self.assertOnlyIn((3, 3), detect("from signal import SIG_BLOCK"))

  def test_SIG_SETMASK_of_signal(self):
    self.assertOnlyIn((3, 3), detect("from signal import SIG_SETMASK"))

  def test_SIG_UNBLOCK_of_signal(self):
    self.assertOnlyIn((3, 3), detect("from signal import SIG_UNBLOCK"))

  def test_ENABLE_USER_SITE_of_site(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from site import ENABLE_USER_SITE"))

  def test_PREFIXES_of_site(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from site import PREFIXES"))

  def test_USER_BASE_of_site(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from site import USER_BASE"))

  def test_USER_SITE_of_site(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from site import USER_SITE"))

  def test_AF_ALG_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import AF_ALG"))

  def test_AF_CAN_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import AF_CAN"))

  def test_AF_LINK_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import AF_LINK"))

  def test_AF_QIPCRTR_of_socket(self):
    self.assertOnlyIn((3, 8), detect("from socket import AF_QIPCRTR"))

  def test_AF_RDS_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import AF_RDS"))

  def test_AF_TIPC_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import AF_TIPC"))

  def test_AF_VSOCK_of_socket(self):
    self.assertOnlyIn((3, 7), detect("from socket import AF_VSOCK"))

  def test_ALG_OP_DECRYPT_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import ALG_OP_DECRYPT"))

  def test_ALG_OP_ENCRYPT_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import ALG_OP_ENCRYPT"))

  def test_ALG_OP_SIGN_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import ALG_OP_SIGN"))

  def test_ALG_OP_VERIFY_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import ALG_OP_VERIFY"))

  def test_ALG_SET_AEAD_ASSOCLEN_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import ALG_SET_AEAD_ASSOCLEN"))

  def test_ALG_SET_AEAD_AUTHSIZE_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import ALG_SET_AEAD_AUTHSIZE"))

  def test_ALG_SET_IV_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import ALG_SET_IV"))

  def test_ALG_SET_KEY_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import ALG_SET_KEY"))

  def test_ALG_SET_OP_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import ALG_SET_OP"))

  def test_ALG_SET_PUBKEY_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import ALG_SET_PUBKEY"))

  def test_CAN_BCM_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM"))

  def test_CAN_BCM_CAN_FD_FRAME_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_CAN_FD_FRAME"))

  def test_CAN_BCM_RX_ANNOUNCE_RESUME_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_RX_ANNOUNCE_RESUME"))

  def test_CAN_BCM_RX_CHANGED_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_RX_CHANGED"))

  def test_CAN_BCM_RX_CHECK_DLC_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_RX_CHECK_DLC"))

  def test_CAN_BCM_RX_DELETE_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_RX_DELETE"))

  def test_CAN_BCM_RX_FILTER_ID_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_RX_FILTER_ID"))

  def test_CAN_BCM_RX_NO_AUTOTIMER_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_RX_NO_AUTOTIMER"))

  def test_CAN_BCM_RX_READ_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_RX_READ"))

  def test_CAN_BCM_RX_RTR_FRAME_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_RX_RTR_FRAME"))

  def test_CAN_BCM_RX_SETUP_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_RX_SETUP"))

  def test_CAN_BCM_RX_STATUS_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_RX_STATUS"))

  def test_CAN_BCM_RX_TIMEOUT_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_RX_TIMEOUT"))

  def test_CAN_BCM_SETTIMER_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_SETTIMER"))

  def test_CAN_BCM_STARTTIMER_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_STARTTIMER"))

  def test_CAN_BCM_TX_ANNOUNCE_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_TX_ANNOUNCE"))

  def test_CAN_BCM_TX_COUNTEVT_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_TX_COUNTEVT"))

  def test_CAN_BCM_TX_CP_CAN_ID_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_TX_CP_CAN_ID"))

  def test_CAN_BCM_TX_DELETE_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_TX_DELETE"))

  def test_CAN_BCM_TX_EXPIRED_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_TX_EXPIRED"))

  def test_CAN_BCM_TX_READ_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_TX_READ"))

  def test_CAN_BCM_TX_RESET_MULTI_IDX_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_TX_RESET_MULTI_IDX"))

  def test_CAN_BCM_TX_SEND_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_TX_SEND"))

  def test_CAN_BCM_TX_SETUP_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_TX_SETUP"))

  def test_CAN_BCM_TX_STATUS_of_socket(self):
    self.assertOnlyIn((3, 4), detect("from socket import CAN_BCM_TX_STATUS"))

  def test_CAN_EFF_FLAG_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import CAN_EFF_FLAG"))

  def test_CAN_EFF_MASK_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import CAN_EFF_MASK"))

  def test_CAN_ERR_FLAG_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import CAN_ERR_FLAG"))

  def test_CAN_ERR_MASK_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import CAN_ERR_MASK"))
  ...
  def test_CAN_RAW_FILTER_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import CAN_RAW_FILTER"))

  def test_CAN_RAW_LOOPBACK_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import CAN_RAW_LOOPBACK"))

  def test_CAN_RAW_RECV_OWN_MSGS_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import CAN_RAW_RECV_OWN_MSGS"))

  def test_CAN_RTR_FLAG_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import CAN_RTR_FLAG"))

  def test_CAN_SFF_MASK_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import CAN_SFF_MASK"))

  def test_IOCTL_VM_SOCKETS_GET_LOCAL_CID_of_socket(self):
    self.assertOnlyIn((3, 7), detect("from socket import IOCTL_VM_SOCKETS_GET_LOCAL_CID"))

  def test_PF_CAN_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import PF_CAN"))

  def test_PF_RDS_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import PF_RDS"))

  def test_RCVALL_IPLEVEL_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import RCVALL_IPLEVEL"))

  def test_RCVALL_MAX_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import RCVALL_MAX"))

  def test_RCVALL_OFF_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import RCVALL_OFF"))

  def test_RCVALL_ON_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import RCVALL_ON"))

  def test_RCVALL_SOCKETLEVELONLY_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import RCVALL_SOCKETLEVELONLY"))

  def test_RDS_CANCEL_SENT_TO_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_CANCEL_SENT_TO"))

  def test_RDS_CMSG_RDMA_ARGS_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_CMSG_RDMA_ARGS"))

  def test_RDS_CMSG_RDMA_DEST_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_CMSG_RDMA_DEST"))

  def test_RDS_CMSG_RDMA_MAP_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_CMSG_RDMA_MAP"))

  def test_RDS_CMSG_RDMA_STATUS_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_CMSG_RDMA_STATUS"))

  def test_RDS_CMSG_RDMA_UPDATE_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_CMSG_RDMA_UPDATE"))

  def test_RDS_CONG_MONITOR_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_CONG_MONITOR"))

  def test_RDS_FREE_MR_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_FREE_MR"))

  def test_RDS_GET_MR_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_GET_MR"))

  def test_RDS_GET_MR_FOR_DEST_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_GET_MR_FOR_DEST"))

  def test_RDS_RDMA_DONTWAIT_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_RDMA_DONTWAIT"))

  def test_RDS_RDMA_FENCE_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_RDMA_FENCE"))

  def test_RDS_RDMA_INVALIDATE_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_RDMA_INVALIDATE"))

  def test_RDS_RDMA_NOTIFY_ME_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_RDMA_NOTIFY_ME"))

  def test_RDS_RDMA_READWRITE_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_RDMA_READWRITE"))

  def test_RDS_RDMA_SILENT_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_RDMA_SILENT"))

  def test_RDS_RDMA_USE_ONCE_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_RDMA_USE_ONCE"))

  def test_RDS_RECVERR_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import RDS_RECVERR"))

  def test_SIO_KEEPALIVE_VALS_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import SIO_KEEPALIVE_VALS"))

  def test_SIO_LOOPBACK_FAST_PATH_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import SIO_LOOPBACK_FAST_PATH"))

  def test_SIO_RCVALL_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import SIO_RCVALL"))

  def test_SOCK_CLOEXEC_of_socket(self):
    self.assertOnlyIn((3, 2), detect("from socket import SOCK_CLOEXEC"))

  def test_SOCK_NONBLOCK_of_socket(self):
    self.assertOnlyIn((3, 2), detect("from socket import SOCK_NONBLOCK"))

  def test_SOL_ALG_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import SOL_ALG"))

  def test_SOL_CAN_BASE_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import SOL_CAN_BASE"))

  def test_SOL_CAN_RAW_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import SOL_CAN_RAW"))

  def test_SOL_RDS_of_socket(self):
    self.assertOnlyIn((3, 3), detect("from socket import SOL_RDS"))

  def test_SOL_TIPC_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import SOL_TIPC"))

  def test_SO_DOMAIN_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import SO_DOMAIN"))

  def test_SO_PASSSEC_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import SO_PASSSEC"))

  def test_SO_PEERSEC_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import SO_PEERSEC"))

  def test_SO_PROTOCOL_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import SO_PROTOCOL"))

  def test_SO_VM_SOCKETS_BUFFER_MAX_SIZE_of_socket(self):
    self.assertOnlyIn((3, 7), detect("from socket import SO_VM_SOCKETS_BUFFER_MAX_SIZE"))

  def test_SO_VM_SOCKETS_BUFFER_MIN_SIZE_of_socket(self):
    self.assertOnlyIn((3, 7), detect("from socket import SO_VM_SOCKETS_BUFFER_MIN_SIZE"))

  def test_SO_VM_SOCKETS_BUFFER_SIZE_of_socket(self):
    self.assertOnlyIn((3, 7), detect("from socket import SO_VM_SOCKETS_BUFFER_SIZE"))

  def test_TCP_CONGESTION_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import TCP_CONGESTION"))

  def test_TCP_NOTSENT_LOWAT_of_socket(self):
    self.assertOnlyIn((3, 7), detect("from socket import TCP_NOTSENT_LOWAT"))

  def test_TCP_USER_TIMEOUT_of_socket(self):
    self.assertOnlyIn((3, 6), detect("from socket import TCP_USER_TIMEOUT"))

  def test_TIPC_ADDR_ID_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_ADDR_ID"))

  def test_TIPC_ADDR_NAME_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_ADDR_NAME"))

  def test_TIPC_ADDR_NAMESEQ_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_ADDR_NAMESEQ"))

  def test_TIPC_CFG_SRV_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_CFG_SRV"))

  def test_TIPC_CLUSTER_SCOPE_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_CLUSTER_SCOPE"))

  def test_TIPC_CONN_TIMEOUT_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_CONN_TIMEOUT"))

  def test_TIPC_CRITICAL_IMPORTANCE_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_CRITICAL_IMPORTANCE"))

  def test_TIPC_DEST_DROPPABLE_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_DEST_DROPPABLE"))

  def test_TIPC_HIGH_IMPORTANCE_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_HIGH_IMPORTANCE"))

  def test_TIPC_IMPORTANCE_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_IMPORTANCE"))

  def test_TIPC_LOW_IMPORTANCE_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_LOW_IMPORTANCE"))

  def test_TIPC_MEDIUM_IMPORTANCE_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_MEDIUM_IMPORTANCE"))

  def test_TIPC_NODE_SCOPE_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_NODE_SCOPE"))

  def test_TIPC_PUBLISHED_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_PUBLISHED"))

  def test_TIPC_SRC_DROPPABLE_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_SRC_DROPPABLE"))

  def test_TIPC_SUBSCR_TIMEOUT_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_SUBSCR_TIMEOUT"))

  def test_TIPC_SUB_CANCEL_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_SUB_CANCEL"))

  def test_TIPC_SUB_PORTS_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_SUB_PORTS"))

  def test_TIPC_SUB_SERVICE_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_SUB_SERVICE"))

  def test_TIPC_TOP_SRV_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_TOP_SRV"))

  def test_TIPC_WAIT_FOREVER_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_WAIT_FOREVER"))

  def test_TIPC_WITHDRAWN_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_WITHDRAWN"))

  def test_TIPC_ZONE_SCOPE_of_socket(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from socket import TIPC_ZONE_SCOPE"))

  def test_VMADDR_CID_ANY_of_socket(self):
    self.assertOnlyIn((3, 7), detect("from socket import VMADDR_CID_ANY"))

  def test_VMADDR_CID_HOST_of_socket(self):
    self.assertOnlyIn((3, 7), detect("from socket import VMADDR_CID_HOST"))
  ...
  def test_family_from_socket_socket(self):
    self.assertOnlyIn(((2, 5), (3, 0)),
                      detect("from socket import socket\n"
                             "socket().family"))
  ...
  def test_HAS_SSLv3_of_ssl(self):
    self.assertOnlyIn((3, 7), detect("from ssl import HAS_SSLv3"))

  def test_OP_NO_RENEGOTIATION_of_ssl(self):
    self.assertOnlyIn((3, 7), detect("from ssl import OP_NO_RENEGOTIATION"))

  def test_PROTOCOL_TLS_CLIENT_of_ssl(self):
    self.assertOnlyIn((3, 6), detect("from ssl import PROTOCOL_TLS_CLIENT"))

  def test_PROTOCOL_TLS_SERVER_of_ssl(self):
    self.assertOnlyIn((3, 6), detect("from ssl import PROTOCOL_TLS_SERVER"))

  def test_CLIENT_AUTH_from_ssl_Purpose(self):
    self.assertOnlyIn(((2, 7), (3, 4)),
                      detect("from ssl import Purpose\n"
                             "Purpose().CLIENT_AUTH"))
  ...
  def test_braceidpattern_from_string_Template(self):
    self.assertOnlyIn((3, 7),
                      detect("from string import Template\n"
  ...
  def test_letters_of_string(self):
    self.assertOnlyIn((2, 0), detect("from string import letters"))

  def test_lowercase_of_string(self):
    self.assertOnlyIn((2, 0), detect("from string import lowercase"))

  def test_uppercase_of_string(self):
    self.assertOnlyIn((2, 0), detect("from string import uppercase"))

  def test_stderr_from_subprocess_CalledProcessError(self):
    self.assertOnlyIn((3, 5),
                      detect("from subprocess import CalledProcessError\n"
  ...
  def test_lpAttributeList_from_subprocess_STARTUPINFO(self):
    self.assertOnlyIn((3, 7),
                      detect("from subprocess import STARTUPINFO\n"
                             "STARTUPINFO().lpAttributeList"))

  def test_stderr_from_subprocess_TimeoutExpired(self):
    self.assertOnlyIn((3, 5),
                      detect("from subprocess import TimeoutExpired\n"
  ...
  def test___breakpointhook___of_sys(self):
    self.assertOnlyIn((3, 7), detect("from sys import __breakpointhook__"))

  def test___interactivehook___of_sys(self):
    self.assertOnlyIn((3, 4), detect("from sys import __interactivehook__"))

  def test___unraisablehook___of_sys(self):
    self.assertOnlyIn((3, 8), detect("from sys import __unraisablehook__"))

  def test__xoptions_of_sys(self):
    self.assertOnlyIn((3, 2), detect("from sys import _xoptions"))

  def test_abiflags_of_sys(self):
    self.assertOnlyIn((3, 2), detect("from sys import abiflags"))

  def test_base_exec_prefix_of_sys(self):
    self.assertOnlyIn((3, 3), detect("from sys import base_exec_prefix"))

  def test_base_prefix_of_sys(self):
    self.assertOnlyIn((3, 3), detect("from sys import base_prefix"))
  ...
  def test_build_from_sys_getwindowsversion(self):
    self.assertOnlyIn(((2, 7), (3, 0)),
                      detect("from sys import getwindowsversion\n"
  ...
  def test_hash_info_of_sys(self):
    self.assertOnlyIn((3, 2), detect("from sys import hash_info"))

  def test_algorithm_from_sys_hash_info(self):
    self.assertOnlyIn((3, 4),
                      detect("from sys import hash_info\n"
                             "hash_info().algorithm"))
  ...
  def test_implementation_of_sys(self):
    self.assertOnlyIn((3, 3), detect("from sys import implementation"))

  def test_int_info_of_sys(self):
    self.assertOnlyIn((3, 1), detect("from sys import int_info"))

  def test_thread_info_of_sys(self):
    self.assertOnlyIn((3, 3), detect("from sys import thread_info"))

  def test_major_from_sys_version_info(self):
    self.assertOnlyIn(((2, 7), (3, 0)),
                      detect("from sys import version_info\n"
                             "version_info().major"))
  ...
  def test_DEFAULT_FORMAT_of_tarfile(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from tarfile import DEFAULT_FORMAT"))

  def test_GNU_FORMAT_of_tarfile(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from tarfile import GNU_FORMAT"))

  def test_PAX_FORMAT_of_tarfile(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from tarfile import PAX_FORMAT"))

  def test_USTAR_FORMAT_of_tarfile(self):
    self.assertOnlyIn(((2, 6), (3, 0)), detect("from tarfile import USTAR_FORMAT"))

  def test_break_on_hyphens_from_textwrap_TextWrapper(self):
    self.assertOnlyIn(((2, 6), (3, 0)),
                      detect("from textwrap import TextWrapper\n"
  ...
  def test_tm_gmtoff_from_time_struct_time(self):
    self.assertOnlyIn((3, 3),
                      detect("from time import struct_time\n"
  ...
  def test_ASYNC_of_token(self):
    self.assertOnlyIn((3, 5), detect("from token import ASYNC"))

  def test_AWAIT_of_token(self):
    self.assertOnlyIn((3, 5), detect("from token import AWAIT"))

  def test_COMMENT_of_token(self):
    self.assertOnlyIn((3, 7), detect("from token import COMMENT"))

  def test_ENCODING_of_token(self):
    self.assertOnlyIn((3, 7), detect("from token import ENCODING"))

  def test_NL_of_token(self):
    self.assertOnlyIn((3, 7), detect("from token import NL"))

  def test_TYPE_COMMENT_of_token(self):
    self.assertOnlyIn((3, 8), detect("from token import TYPE_COMMENT"))

  def test_domain_from_tracemalloc_Filter(self):
    self.assertOnlyIn((3, 6),
                      detect("from tracemalloc import Filter\n"
                             "Filter().domain"))
  ...
  def test_BooleanType_of_types(self):
    self.assertOnlyIn((2, 3), detect("from types import BooleanType"))

  def test_CellType_of_types(self):
    self.assertOnlyIn((3, 8), detect("from types import CellType"))

  def test_ClassMethodDescriptorType_of_types(self):
    self.assertOnlyIn((3, 7), detect("from types import ClassMethodDescriptorType"))

  def test_CoroutineType_of_types(self):
    self.assertOnlyIn((3, 5), detect("from types import CoroutineType"))

  def test_GeneratorType_of_types(self):
    self.assertOnlyIn(((2, 2), (3, 0)), detect("from types import GeneratorType"))

  def test_GetSetDescriptorType_of_types(self):
    self.assertOnlyIn(((2, 5), (3, 0)), detect("from types import GetSetDescriptorType"))

  def test_MemberDescriptorType_of_types(self):
    self.assertOnlyIn(((2, 5), (3, 0)), detect("from types import MemberDescriptorType"))

  def test_MethodDescriptorType_of_types(self):
    self.assertOnlyIn((3, 7), detect("from types import MethodDescriptorType"))

  def test_MethodWrapperType_of_types(self):
    self.assertOnlyIn((3, 7), detect("from types import MethodWrapperType"))

  def test_StringTypes_of_types(self):
    self.assertOnlyIn((2, 2), detect("from types import StringTypes"))

  def test_WrapperDescriptorType_of_types(self):
    self.assertOnlyIn((3, 7), detect("from types import WrapperDescriptorType"))
  ...
  def test_unidata_version_of_unicodedata(self):
    self.assertOnlyIn(((2, 3), (3, 0)), detect("from unicodedata import unidata_version"))
  ...
  def test_headers_from_urllib_error_HTTPError(self):
    self.assertOnlyIn((3, 4),
                      detect("from urllib.error import HTTPError\n"
                             "HTTPError().headers"))
  ...
  def test_fragment_from_urlparse_urlparse(self):
    self.assertOnlyIn((2, 5),
                      detect("from urlparse import urlparse\n"
                             "urlparse().fragment"))
  ...
  def test_fragment_from_urlparse_urlsplit(self):
    self.assertOnlyIn((2, 5),
                      detect("from urlparse import urlsplit\n"
                             "urlsplit().fragment"))
  ...
  def test_is_safe_from_uuid_UUID(self):
    self.assertOnlyIn((3, 7),
                      detect("from uuid import UUID\n"
                             "UUID().is_safe"))

  def test___callback___from_weakref_ref(self):
    self.assertOnlyIn((3, 4),
                      detect("from weakref import ref\n"
                             "ref().__callback__"))

  def test_REG_QWORD_of_winreg(self):
    self.assertOnlyIn((3, 6), detect("from winreg import REG_QWORD"))

  def test_REG_QWORD_LITTLE_ENDIAN_of_winreg(self):
    self.assertOnlyIn((3, 6), detect("from winreg import REG_QWORD_LITTLE_ENDIAN"))

  def test_code_from_xml_parsers_expat_ExpatError(self):
    self.assertOnlyIn(((2, 1), (3, 0)),
                      detect("from xml.parsers.expat import ExpatError\n"
                             "ExpatError().code"))
  ...
  def test_CurrentByteIndex_from_xml_parsers_expat_XMLParserType(self):
    self.assertOnlyIn(((2, 4), (3, 0)),
                      detect("from xml.parsers.expat import XMLParserType\n"
  ...
  def test_codes_from_xml_parsers_expat_errors(self):
    self.assertOnlyIn((3, 2),
                      detect("from xml.parsers.expat import errors\n"
                             "errors().codes"))
  ...
  def test_ZLIB_RUNTIME_VERSION_of_zlib(self):
    self.assertOnlyIn((3, 3), detect("from zlib import ZLIB_RUNTIME_VERSION"))

  def test_avoids_symlink_attacks_of_shutil_rmtree(self):
    self.assertOnlyIn((3, 3), detect("from shutil import rmtree\n"
                                     "rmtree.avoids_symlink_attacks"))

  def test_html5_of_html_entities(self):
    self.assertOnlyIn((3, 3), detect("from html.entities import html5"))

  def test_DOMSTRING_SIZE_ERR_of_xml_dom(self):
    self.assertOnlyIn(((2, 1), (3, 0)), detect("from xml.dom import DOMSTRING_SIZE_ERR"))

  def test_EMPTY_NAMESPACE_of_xml_dom(self):
    self.assertOnlyIn(((2, 2), (3, 0)), detect("from xml.dom import EMPTY_NAMESPACE"))

  def test_HIERARCHY_REQUEST_ERR_of_xml_dom(self):
    self.assertOnlyIn(((2, 1), (3, 0)), detect("from xml.dom import HIERARCHY_REQUEST_ERR"))

  def test_INDEX_SIZE_ERR_of_xml_dom(self):
    self.assertOnlyIn(((2, 1), (3, 0)), detect("from xml.dom import INDEX_SIZE_ERR"))

  def test_INUSE_ATTRIBUTE_ERR_of_xml_dom(self):
    self.assertOnlyIn(((2, 1), (3, 0)), detect("from xml.dom import INUSE_ATTRIBUTE_ERR"))

  def test_INVALID_ACCESS_ERR_of_xml_dom(self):
    self.assertOnlyIn(((2, 1), (3, 0)), detect("from xml.dom import INVALID_ACCESS_ERR"))

  def test_INVALID_CHARACTER_ERR_of_xml_dom(self):
    self.assertOnlyIn(((2, 1), (3, 0)), detect("from xml.dom import INVALID_CHARACTER_ERR"))

  def test_INVALID_MODIFICATION_ERR_of_xml_dom(self):
    self.assertOnlyIn(((2, 1), (3, 0)), detect("from xml.dom import INVALID_MODIFICATION_ERR"))

  def test_INVALID_STATE_ERR_of_xml_dom(self):
    self.assertOnlyIn(((2, 1), (3, 0)), detect("from xml.dom import INVALID_STATE_ERR"))

  def test_NAMESPACE_ERR_of_xml_dom(self):
    self.assertOnlyIn(((2, 1), (3, 0)), detect("from xml.dom import NAMESPACE_ERR"))

  def test_NOT_FOUND_ERR_of_xml_dom(self):
    self.assertOnlyIn(((2, 1), (3, 0)), detect("from xml.dom import NOT_FOUND_ERR"))

  def test_NOT_SUPPORTED_ERR_of_xml_dom(self):
    self.assertOnlyIn(((2, 1), (3, 0)), detect("from xml.dom import NOT_SUPPORTED_ERR"))
  ...
  def test_WRONG_DOCUMENT_ERR_of_xml_dom(self):
    self.assertOnlyIn(((2, 1), (3, 0)), detect("from xml.dom import WRONG_DOCUMENT_ERR"))

  def test_XHTML_NAMESPACE_of_xml_dom(self):
    self.assertOnlyIn(((2, 2), (3, 0)), detect("from xml.dom import XHTML_NAMESPACE"))

  def test_XMLNS_NAMESPACE_of_xml_dom(self):
    self.assertOnlyIn(((2, 2), (3, 0)), detect("from xml.dom import XMLNS_NAMESPACE"))
