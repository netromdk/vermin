...
def MOD_REQS(config):
  return {
    ...
    "popen2": ((2, 0), None),
    "profiling": (None, (3, 15)),
    "profiling.sampling": (None, (3, 15)),
    "profiling.tracing": (None, (3, 15)),
    "pyclbr": ((2, 0), (3, 0)),
    "pydoc": ((2, 1), (3, 0)),
    "queue": (None, (3, 0)),
    "random": ((2, 0), (3, 0)),
...
def MOD_MEM_REQS(config):
  return {
    ...
    "abc.ABC": (None, (3, 4)),
    "annotationlib.Format": (None, (3, 14)),
    "argparse.BooleanOptionalAction": (None, (3, 9)),
    "ast.Constant": (None, (3, 6)),
    ...
    "importlib.metadata.MetadataNotFound": (None, (3, 15)),
    ...
    "string.templatelib.Interpolation": (None, (3, 14)),
    "string.templatelib.Template": (None, (3, 14)),
    ...
    "asyncio.BrokenBarrierError": (None, (3, 11)),
    ...
    "concurrent.interpreters.BrokenInterpreterPool": (None, (3, 14)),
    "concurrent.interpreters.ExecutionFailed": (None, (3, 14)),
    ...
    "bytearray.take_bytes": (None, (3, 15)),
    "bytes.hex": (None, (3, 5)),
    ...
    "asyncio.Server.get_loop": (None, (3, 9)),
    "asyncio.Server.is_serving": (None, (3, 9)),
    "asyncio.Server.serve_forever": (None, (3, 9)),
    "asyncio.Server.start_serving": (None, (3, 9)),
    ...
    "asyncio.TaskGroup.cancel": (None, (3, 15)),
    ...
    "binascii.a2b_ascii85": (None, (3, 15)),
    "binascii.a2b_base32": (None, (3, 15)),
    "binascii.a2b_base85": (None, (3, 15)),
    "binascii.b2a_ascii85": (None, (3, 15)),
    "binascii.b2a_base32": (None, (3, 15)),
    "binascii.b2a_base85": (None, (3, 15)),
    ...
    "collections.Counter.__ixor__": (None, (3, 15)),
    "collections.Counter.__xor__": (None, (3, 15)),
    ...
    "collections.UserString.removeprefix": (None, (3, 9)),
    ...
    "configparser.ExtendedInterpolation": bpv("configparser", (None, (3, 2)), config),
    ...
    "dbm.dumb.reorganize": (None, (3, 15)),
    "dbm.gdbm.clear": (None, (3, 13)),
    "dbm.ndbm.clear": (None, (3, 13)),
    "dbm.sqlite3.reorganize": (None, (3, 15)),
    ...
    "dis.hasarg": (None, (3, 12)),
    "dis.hasexc": (None, (3, 12)),
    ...
    "http.server.SimpleHTTPRequestHandler.default_content_type": (None, (3, 15)),
    ...
    "math.isinf": ((2, 6), (3, 0)),
    "math.isnan": ((2, 6), (3, 0)),
    "math.isnormal": (None, (3, 15)),
    "math.isqrt": (None, (3, 8)),
    "math.issubnormal": (None, (3, 15)),
    "math.lcm": (None, (3, 9)),
    "math.lgamma": ((2, 7), (3, 2)),
    "math.log1p": ((2, 6), (3, 0)),
    "math.log2": (None, (3, 3)),
    ...
    "pathlib.Path.full_match": (None, (3, 13)),
    ...
    "pathlib.Path.with_segments": (None, (3, 12)),
    "pathlib.Path.with_stem": (None, (3, 9)),
    ...
    "random.Random.randbytes": (None, (3, 9)),
    ...
    "re.Pattern.prefixmatch": (None, (3, 15)),
    "re.finditer": ((2, 2), (3, 0)),
    "re.fullmatch": (None, (3, 4)),
    "re.prefixmatch": (None, (3, 15)),
    ...
    "shelve.Shelf.reorganize": (None, (3, 15)),
    "shlex.join": (None, (3, 8)),
    ...
    "ssl.SSLContext.set_server_sigalgs": (None, (3, 15)),
    "ssl.SSLContext.set_servername_callback": ((2, 7), (3, 4)),
    "ssl.SSLSocket.client_sigalg": (None, (3, 15)),
    ...
    "symtable.Function.get_cells": (None, (3, 15)),
    "symtable.Symbol.is_annotated": (None, (3, 6)),
    "symtable.Symbol.is_cell": (None, (3, 15)),
    ...
    "sys.get_lazy_imports": (None, (3, 15)),
    ...
    "sys.set_lazy_imports": (None, (3, 15)),
    "sys.set_lazy_imports_filter": (None, (3, 15)),
    ...
    "threading.concurrent_tee": (None, (3, 15)),
    ...
    "threading.serialize_iterator": (None, (3, 15)),
    ...
    "threading.synchronized_iterator": (None, (3, 15)),
    ...
    "tkinter.Event.detail": (None, (3, 15)),
    "tkinter.Event.user_data": (None, (3, 15)),
    "tkinter.Text.search_all": (None, (3, 15)),
    "tkinter.grid_content": (None, (3, 15)),
    "tkinter.info_patchlevel": (None, (3, 11)),
    "tkinter.pack_content": (None, (3, 15)),
    "tkinter.place_content": (None, (3, 15)),
    "tkinter.ttk": (None, (3, 1)),
    ...
    "types.FrameLocalsProxyType": (None, (3, 15)),
    "types.LazyImportType": (None, (3, 15)),
    ...
    "unicodedata.block": (None, (3, 15)),
    "unicodedata.east_asian_width": ((2, 4), (3, 0)),
    "unicodedata.extended_pictographic": (None, (3, 15)),
    "unicodedata.grapheme_cluster_break": (None, (3, 15)),
    "unicodedata.indic_conjunct_break": (None, (3, 15)),
    "unicodedata.iter_graphemes": (None, (3, 15)),
    "unicodedata.is_normalized": (None, (3, 8)),
    "unicodedata.isxidcontinue": (None, (3, 15)),
    "unicodedata.isxidstart": (None, (3, 15)),
    ...
    "wave.Wave_read.getformat": (None, (3, 15)),
    "wave.Wave_write.getformat": (None, (3, 15)),
    "wave.Wave_write.setformat": (None, (3, 15)),
    "wave.Wave_write.setparams": (None, (3, 15)),
    ...
    "xml.parsers.expat.xmlparser.SetBillionLaughsAttackProtection"
    "ActivationThreshold": (None, (3, 15)),
    "xml.parsers.expat.xmlparser.SetBillionLaughsAttackProtection"
    "MaximumAmplification": (None, (3, 15)),
    ...
    "xml.is_valid_name": (None, (3, 15)),
    "xml.is_valid_text": (None, (3, 15)),
    ...
    "zlib.adler32_combine": (None, (3, 15)),
    "zlib.Compress.copy": ((2, 5), (3, 0)),
    "zlib.crc32_combine": (None, (3, 15)),
    ...
    "annotationlib.Format.FORWARDREF": (None, (3, 14)),
    "annotationlib.Format.STRING": (None, (3, 14)),
    "annotationlib.Format.VALUE": (None, (3, 14)),
    "annotationlib.Format.VALUE_WITH_FAKE_GLOBALS": (None, (3, 14)),
    ...
    "email.policy.EmailPolicy.utf8": (None, (3, 5)),
    ...
    "resource.RLIMIT_NTHR": (None, (3, 15)),
    "resource.RLIMIT_THREADS": (None, (3, 15)),
    "resource.RLIMIT_UMTXP": (None, (3, 15)),
    "resource.RLIM_SAVED_CUR": (None, (3, 15)),
    "resource.RLIM_SAVED_MAX": (None, (3, 15)),
    ...
    "xml.parsers.expat.SetAllocTrackerActivationThreshold": (None, (3, 15)),
    "xml.parsers.expat.SetAllocTrackerMaximumAmplification": (None, (3, 15)),
    ...
    "typing.disjoint_base": (None, (3, 15)),
    "typing.final": (None, (3, 8)) if not bp("typing", config) else ((2, 7), (3, 8)),
...
def KWARGS_REQS(config):
  return {
    ...
    ("base64.a85decode", "canonical"): (None, (3, 15)),
    ("base64.b16decode", "ignorechars"): (None, (3, 15)),
    ("base64.b16encode", "wrapcol"): (None, (3, 15)),
    ("base64.b32decode", "canonical"): (None, (3, 15)),
    ("base64.b32decode", "ignorechars"): (None, (3, 15)),
    ("base64.b32decode", "padded"): (None, (3, 15)),
    ("base64.b32encode", "padded"): (None, (3, 15)),
    ("base64.b32encode", "wrapcol"): (None, (3, 15)),
    ("base64.b32hexdecode", "canonical"): (None, (3, 15)),
    ("base64.b32hexdecode", "ignorechars"): (None, (3, 15)),
    ("base64.b32hexdecode", "padded"): (None, (3, 15)),
    ("base64.b32hexencode", "padded"): (None, (3, 15)),
    ("base64.b32hexencode", "wrapcol"): (None, (3, 15)),
    ("base64.b64decode", "canonical"): (None, (3, 15)),
    ("base64.b64decode", "ignorechars"): (None, (3, 15)),
    ("base64.b64decode", "padded"): (None, (3, 15)),
    ("base64.b64encode", "padded"): (None, (3, 15)),
    ("base64.b64encode", "wrapcol"): (None, (3, 15)),
    ("base64.b85decode", "canonical"): (None, (3, 15)),
    ("base64.b85decode", "ignorechars"): (None, (3, 15)),
    ("base64.b85encode", "wrapcol"): (None, (3, 15)),
    ("base64.urlsafe_b64decode", "padded"): (None, (3, 15)),
    ("base64.urlsafe_b64encode", "padded"): (None, (3, 15)),
    ("base64.z85decode", "canonical"): (None, (3, 15)),
    ("base64.z85decode", "ignorechars"): (None, (3, 15)),
    ("base64.z85encode", "pad"): (None, (3, 15)),
    ("base64.z85encode", "wrapcol"): (None, (3, 15)),
    ("bdb.Bdb", "skip"): ((2, 7), (3, 1)),
    ("binascii.a2b_base32", "padded"): (None, (3, 15)),
    ("binascii.a2b_base64", "alphabet"): (None, (3, 15)),
    ("binascii.a2b_base64", "canonical"): (None, (3, 15)),
    ("binascii.a2b_base64", "ignorechars"): (None, (3, 15)),
    ("binascii.a2b_base64", "padded"): (None, (3, 15)),
    ("binascii.a2b_base64", "strict_mode"): (None, (3, 11)),
    ("binascii.a2b_hex", "ignorechars"): (None, (3, 15)),
    ("binascii.b2a_base32", "padded"): (None, (3, 15)),
    ("binascii.b2a_base64", "alphabet"): (None, (3, 15)),
    ("binascii.b2a_base64", "newline"): (None, (3, 6)),
    ("binascii.b2a_base64", "padded"): (None, (3, 15)),
    ("binascii.b2a_base64", "wrapcol"): (None, (3, 15)),
    ...
    ("binascii.unhexlify", "ignorechars"): (None, (3, 15)),
    ...
    ("bytes.replace", "count"): (None, (3, 15)),
    ("bytearray.replace", "count"): (None, (3, 15)),
    ...
    ("difflib.unified_diff", "color"): (None, (3, 15)),
    ...
    ("faulthandler.dump_traceback", "max_threads"): (None, (3, 15)),
    ("faulthandler.dump_traceback_later", "max_threads"): (None, (3, 15)),
    ("faulthandler.enable", "max_threads"): (None, (3, 15)),
    ("faulthandler.register", "max_threads"): (None, (3, 15)),
    ...
    ("http.client.HTTPConnection", "blocksize"): (None, (3, 7)),
    ("http.client.HTTPConnection", "max_response_headers"): (None, (3, 15)),
    ...
    ("http.client.HTTPSConnection", "max_response_headers"): (None, (3, 15)),
    ...
    ("http.server.SimpleHTTPRequestHandler", "extra_response_headers"): (None, (3, 15)),
    ...
    ("importlib.abc.InspectLoader.source_to_code", "fullname"): (None, (3, 15)),
    ("importlib.util.cache_from_source", "optimization"): (None, (3, 5)),
    ("inspect.Signature.format", "quote_annotation_strings"): (None, (3, 14)),
    ("inspect.Signature.from_callable", "globals"): (None, (3, 10)),
    ("inspect.Signature.from_callable", "locals"): (None, (3, 10)),
    ("inspect.getdoc", "fallback_to_class_doc"): (None, (3, 15)),
    ("inspect.getdoc", "inherit_class_doc"): (None, (3, 15)),
    ...
    ("json.load", "array_hook"): (None, (3, 15)),
    ("json.load", "object_pairs_hook"): ((2, 7), (3, 1)),
    ("json.loads", "array_hook"): (None, (3, 15)),
    ...
    ("os.makedirs", "parent_mode"): (None, (3, 15)),
    ...
    ("pathlib.Path.match", "case_sensitive"): (None, (3, 12)),
    ("pathlib.Path.mkdir", "exist_ok"): (None, (3, 5)),
    ("pathlib.Path.mkdir", "parent_mode"): (None, (3, 15)),
    ("pathlib.Path.owner", "follow_symlinks"): (None, (3, 13)),
    ("pathlib.Path.read_text", "newline"): (None, (3, 13)),
    ("pathlib.Path.relative_to", "walk_up"): (None, (3, 12)),
    ...
    ("pprint.PrettyPrinter", "expand"): (None, (3, 15)),
    ...
    ("pprint.pformat", "expand"): (None, (3, 15)),
    ...
    ("sum", "start"): (None, (3, 8)),
    ("symtable.symtable", "module"): (None, (3, 15)),
    ...
    ("tkinter.Text.search", "nolinestop"): (None, (3, 15)),
    ("tkinter.Text.search", "strictlimits"): (None, (3, 15)),
    ("timeit.Timer", "globals"): (None, (3, 5)),
    ("timeit.Timer.autorange", "target_time"): (None, (3, 15)),
    ...
    ("unittest.TestCase.assertLogs", "formatter"): (None, (3, 15)),
    ...
    ("urllib.parse.urldefrag", "missing_as_none"): (None, (3, 15)),
    ("urllib.parse.urlencode", "quote_via"): (None, (3, 5)),
    ("urllib.parse.urlparse", "missing_as_none"): (None, (3, 15)),
    ("urllib.parse.urlsplit", "missing_as_none"): (None, (3, 15)),
    ("urllib.parse.urlunparse", "keep_empty"): (None, (3, 15)),
    ("urllib.parse.urlunsplit", "keep_empty"): (None, (3, 15)),
