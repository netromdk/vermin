...
def MOD_MEM_REQS(config):
  return {
    ...
    "dis.GEN_START": (None, (3, 10)),
    "dis.MATCH_CLASS": (None, (3, 10)),
    "dis.ROT_N": (None, (3, 10)),
    ...
    "dis.COPY_DICT_WITHOUT_KEYS": (None, (3, 10)),
    "dis.GET_LEN": (None, (3, 10)),
    "dis.MATCH_KEYS": (None, (3, 10)),
    "dis.MATCH_MAPPING": (None, (3, 10)),
    "dis.MATCH_SEQUENCE": (None, (3, 10)),
    ...
    "types.NoneType": (None, (3, 10)),
    "types.NotImplementedType": (None, (3, 10)),
...
KWARGS_REQS = {
  ...
  ("cgi.parse_multipart", "separator"): (None, (3, 10)),
  ...
  ("urllib.parse.parse_qs", "separator"): (None, (3, 10)),
  ...
  ("urllib.parse.parse_qsl", "separator"): (None, (3, 10)),
