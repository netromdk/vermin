...
def MOD_MEM_REQS():
  return {
    ...
    "urllib.response.addinfourl": (None, (3, 9)),
    ...
    "xml.etree.ElementInclude": (None, (3, 7)),
    ...
    "types.MappingProxyType.reversed": (None, (3, 9)),
    ...
    "xml.etree.ElementTree.Element.indent": (None, (3, 9)),
