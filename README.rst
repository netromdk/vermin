...
matches against internal dictionaries with **3127** rules, covering v2.0-2.7 and v3.0-3.9, divided
...
codecs error handler names, **20** codecs encodings, **38** builtin generic annotation types, **6**
...
The project is fairly well-tested with **3347** unit and integration tests employing **4091**
assertions.
